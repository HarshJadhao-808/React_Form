...
FormRouter.get("/personal_info",tokencheck,personal_get)

FormRouter.post("/personal_info",tokencheck,personal_post)

// educational info

FormRouter.get("/educational_info",tokencheck,educational_get)

FormRouter.post("/educational_info",tokencheck,educational_post)

// professional info

FormRouter.get("/professional_info",tokencheck,professional_get)

FormRouter.post("/professional_info",tokencheck,professional_post)

// identity info

FormRouter.get("/identity_info",tokencheck,identity_get)

FormRouter.post("/identity_info",tokencheck,identity_post)

// Review 

FormRouter.get("/review_info",tokencheck,Review_get)
