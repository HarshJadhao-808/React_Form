	...
	return (
		<>
			...
			<div className="fixed z-2 bg-[linear-gradient(247.34deg,#A1B4FF_1.1%,#FFFFFF_99.7%)] h-full w-full">
				...
				>
					<div className="bg-[#FFFFFF] rounded-[30px] mt-20 sm:mt-0  mb-50 sm:mb-0 w-[80%] h-[65%] sm:h-[85%] sm:w-[517px] flex flex-col gap-3 sm:gap-3 ">
						...
						<div className=" flex justify-center">
							<input
								className=" mt-12 mb-12 sm:mt-12 sm:mb-12  bg-[#0242E1] w-[80%] h-[50px] sm:h-[66px] rounded-[50px] sm:text-[30.83px] text-white font-[halant]  "
								value="Signup"
								type="submit"
							/>
						</div>
